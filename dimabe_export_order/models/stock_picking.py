...
class StockPicking(models.Model):
    ...
    def return_action(self):
        qty = str(self.quantity_done).replace('.00', ',00')
        models._logger.error('6666666666666666666666666666666666666666666666666{}'.format(qty))
        return {
            ...
            "target": "new",
            "context": "{'default_product_id':"+str(self.product.id)+",'default_product_qty':"+str(self.quantity_done).replace('.00', ',00')+",'default_origin':'"+self.name+"'}"
        }
